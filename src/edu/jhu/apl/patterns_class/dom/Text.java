...
public class Text extends Node implements edu.jhu.apl.patterns_class.dom.replacement.Text
{
	...
	public String substringData(int offset, int count) throws IndexOutOfBoundsException
	{
		// TODO:  Check for readonly status.  NO_MODIFICATION_ALLOWED_ERR
	...
	public edu.jhu.apl.patterns_class.dom.replacement.Text splitText(int offset) throws IndexOutOfBoundsException
	{
		// TODO:  Check for readonly status.  NO_MODIFICATION_ALLOWED_ERR
